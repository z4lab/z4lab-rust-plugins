...
*=======================================================================================================================*/
    ...
    public class AdminPanel : RustPlugin
    {
        ...
        private void PleaseDestroyUI(BasePlayer player)
        {
                //CuiHelper.DestroyUi(player, Name);
            string cuielement = string.Empty;
            playercui.TryGetValue(player, out cuielement);
            if (string.IsNullOrEmpty(cuielement)) return;
